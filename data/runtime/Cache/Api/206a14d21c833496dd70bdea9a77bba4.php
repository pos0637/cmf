					...
					<div class="tab-pane" id="C">
						<table width="100%">
							<tbody>
								<tr>
									<td width="140">APPkey</td>
									<td><input type="text" name="wx_key" value="<?php echo (C("THINK_SDK_WEIXIN.APP_KEY")); ?>" /></td>
								</tr>
								<tr>
									<td>APPsecret</td>
									<td><input type="text" name="wx_sec" value="<?php echo (C("THINK_SDK_WEIXIN.APP_SECRET")); ?>" /></td>
								</tr>
								<tr>
									<td><?php echo L('CALLBACK_URL');?></td>
									<td><?php echo ($callback_uri_root); ?>weixin</td>
								</tr>
								<tr>
									<td><?php echo L('CANCEL_CALLBACK_URL');?></td>
									<td><?php echo sp_get_host();?></td>
								...
								<tr>
									<td colspan="2"><a href="https://open.weixin.qq.com" target="_blank"><?php echo L('CLICK_HERE');?></a> 获取微信登录APPKey及APPsecret</td>
								</tr>
							</tbody>
						</table>
					</div>
